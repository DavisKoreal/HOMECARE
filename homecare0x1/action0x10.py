...
def refactor_audit_log():
    ...
    print("\n--- Refactoring lib/screens/audit_log_screen.dart ---")
    log_path = os.path.join("lib", "screens", "audit_log_screen.dart")
    
    log_content = """import 'package:flutter/material.dart';
...
"""
    with open(log_path, "w", encoding="utf-8") as f:
        f.write(log_content)
    print("Rewrote audit_log_screen.dart to Data Table format.")
