...
# add_dashboard_quick_actions.sh: Adds Admin Calendar and Caregiver Calendar quick actions to dashboards
# Run from project root (homecare0x1). Updates:
...
# Update lib/screens/admin_dashboard.dart
cat << 'EOF' > lib/screens/admin_dashboard.dart
...
# Update lib/screens/caregiver_dashboard.dart
cat << 'EOF' > lib/screens/caregiver_dashboard.dart
import 'package:flutter/material.dart';
import 'package:homecare0x1/constants.dart';
import 'package:homecare0x1/providers/user_provider.dart';
...
git add .
git commit -m "Add Admin Calendar and Caregiver Calendar quick actions to dashboards"
